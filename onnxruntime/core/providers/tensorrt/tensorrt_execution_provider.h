...
class TensorrtExecutionProvider : public IExecutionProvider {
  ...
  */
  virtual int GenerateMetaDefId(const GraphViewer& graph_viewer, HashValue& model_hash) const;
  ...
  */
  ...
  // helper to generate ids that are unique to model and deterministic
  class ModelMetadefIdGenerator {
   public:
    int GenerateId(const GraphViewer& graph_viewer, HashValue& model_hash) const;
